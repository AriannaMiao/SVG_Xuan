...
class SVGCircle: public SVGElement, public SVGStyleFill, public SVGStyleStroke, public SVGStyleTransform { //本宝宝写的 
    double cx, cy, r;
public:
	...
	SVGCircle(): SVGElement("circle", ""), SVGStyleFill(), SVGStyleStroke(), SVGStyleTransform() {
		cx = 0;
		cy = 0;
		r = 0;
	} //本宝宝写的 
...
protected:
    virtual SVGElement* clone() const {
        return new SVGCircle(*this);//本宝宝写的
    }
