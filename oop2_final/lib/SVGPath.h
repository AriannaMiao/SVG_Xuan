...
public:
    SVGPath(const std::string& id_): SVGElement("path", id_), SVGStyleFill(), SVGStyleStroke(), SVGStyleTransform() {} //本宝宝写的 
    
    SVGPath(): SVGElement("path", ""), SVGStyleFill(), SVGStyleStroke(), SVGStyleTransform() {} //本宝宝写的

	SVGPath(const SVGPath& path_): SVGElement(path_), SVGStyleFill(path_), SVGStyleStroke(path_), SVGStyleTransform(path_)
	{
		dss << path_.dss.str();
	}//本宝宝写的【方脏 
    ...
    virtual std::ostream& print(std::ostream& out) const {
        print_tag_start(out);
        SVGBase::print_attr(out, "d", dss.str());
